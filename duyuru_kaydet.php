  ...
  $target_path = "uploads/"; //Declaring Path for uploaded images
    ...
    if (($_FILES["file"]["size"][$i] < 10000000) //Approx. 100kb files can be uploaded.
            ...
            if (move_uploaded_file($_FILES['file']['tmp_name'][$i], $target_path)) {
                mysql_query($sql = "INSERT INTO duyurular2 
                (duyuru_basligi, duyuru_icerigi, duyuru_resmi)
                            VALUES 
                            ('".mysql_real_escape_string($_POST['duyuru_basligi'])."',
                             '".mysql_real_escape_string($_POST['duyuru_icerigi'])."',
                             '".$target_path."');");
                            
                                  
                echo $j. ').<span id="noerror">successfully!.</span><br/><br/>';
